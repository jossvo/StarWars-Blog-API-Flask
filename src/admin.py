...
from models import db, User, Planet, People, Film, Starship, Vehicle, Specie, Location, Resident, Filmography, Reg_starship, Reg_vehicles, Members_specie, Specie_filmography
